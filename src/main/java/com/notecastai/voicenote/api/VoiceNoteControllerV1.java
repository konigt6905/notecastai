...
import com.notecastai.voicenote.api.mapper.VoiceNoteCommandMapper;
...
public class VoiceNoteControllerV1 {
    ...
    private final VoiceNoteCommandMapper commandMapper;
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Voice note uploaded successfully"),
    ...
    public CreateVoiceNoteResponse upload(
        ...
        return voiceNoteService.create(commandMapper.toCommand(request));
    }
