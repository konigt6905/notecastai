...
public class GameNoteEntity extends BaseEntity {
    ...
    public void markAsProcessed() {
        this.status = GameNoteStatus.PROCESSED;
        this.errorMessage = null;
    }

    public void markAsFailed(String error) {
        this.status = GameNoteStatus.FAILED;
        this.errorMessage = error != null ? error.substring(0, Math.min(error.length(), 1000)) : "Unknown error occurred";
    }
