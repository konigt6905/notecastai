...
import com.notecastai.gamenote.api.mapper.GameNoteCommandMapper;
...
public class GameNoteControllerV1 {
    ...
    private final GameNoteCommandMapper commandMapper;
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Game note creation initiated successfully"),
    ...
    public CreateGameNoteResponse create(@Valid @RequestBody GameNoteCreateRequest request) {
        return gameNoteService.create(commandMapper.toCommand(request));
    }
    ...
    public GameNoteStatisticsDTO submitStatistics(
        ...
        return statisticsService.submitStatistics(id, commandMapper.toCommand(request));
    }
    ...
    public List<GameNoteStatisticsSummaryDTO> getUserSummaries() {
        return statisticsService.getUserSummaries();
    }
}
