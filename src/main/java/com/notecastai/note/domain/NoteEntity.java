...
public class NoteEntity extends BaseEntity {
    ...
    @Builder.Default
    @Column(name = "current_format", nullable = false, length = 40)
    private FormatType currentFormat = FormatType.DEFAULT;
    ...
    public void applyAiActions(List<AiAction> actions) {
        this.proposedAiActions.clear();
        this.proposedAiActions.addAll(actions);
    }
