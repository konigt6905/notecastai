...
public class NoteExportService {
    ...
    public byte[] exportAsMarkdown(NoteDTO note, String content) {
        ...
        markdown.append("**Format:** ").append(note.getCurrentFormat()).append("\n\n");
    ...
    public byte[] exportAsText(NoteDTO note, String content) {
        ...
        text.append("Format: ").append(note.getCurrentFormat()).append("\n\n");
    ...
    public byte[] exportAsHtml(NoteDTO note, String content) {
        ...
        html.append("<p>Format: ").append(note.getCurrentFormat()).append("</p>\n");
        html.append("</div>\n");
    ...
    public byte[] exportAsPdf(NoteDTO note, String content) {
        try (PDDocument document = new PDDocument(); ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            ...
            throw BusinessException.of(BusinessException.BusinessCode.INTERNAL_ERROR
