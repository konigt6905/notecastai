...
import com.notecastai.notecast.api.mapper.NoteCastCommandMapper;
...
public class NoteCastControllerV1 {
    ...
    private final NoteCastCommandMapper commandMapper;
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "NoteCast created successfully"),
    ...
    public NoteCastResponseDTO create(@Valid @RequestBody NoteCastCreateRequest request) {
        return noteCastService.create(commandMapper.toCommand(request));
    }
