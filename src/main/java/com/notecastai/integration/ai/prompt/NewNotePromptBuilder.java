...
```
    ...
    public String getSystemPrompt() {
        String formatInstructions = formatType != null
                ? "FORMAT TYPE: " + formatType.getLabel() + "\n" + formatType.getPromptText()
    ...
    public String getUserPrompt() {
        ...
        String formatTypeDisplay = formatType != null
                ? formatType.getLabel() + " - " + formatType.getPromptText()
        ...
        String formatInstructionsRepeat = formatType != null
                ? formatType.getPromptText()
